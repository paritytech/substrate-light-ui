...
export function isInstanceOfSingleAddress(object: any): object is SingleAddress {
  // very loose check
  return 'json' in object && 'option' in object;
}

export function isInstanceOfInjectedExtension(object: any): object is InjectedAccountWithMeta { 
